...
if __name__ == '__main__':
    ...
    for category_dir in categories_list:
        ...
        category_train_path = os.path.join(category_root_path, 'train/data')        # Fix: Remove the leading slash
        category_test_path = os.path.join(category_root_path, 'test_public/data')   # Fix: Remove the leading slash
        ...
        num_train_files = len(category_train_files)//17 - 2 if len(category_train_files)%17 > 1000 else len(category_train_files)//17
